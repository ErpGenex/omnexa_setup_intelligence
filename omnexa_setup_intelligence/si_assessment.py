...
from omnexa_setup_intelligence.si_gap_register import get_gap_status
from omnexa_setup_intelligence.si_global_benchmark import get_global_si_score

@frappe.whitelist()
def export_si_global_audit() -> dict:
	root = os.path.join(get_bench_path(), "Docs", "2026-06-06_OMNEXA_SETUP_INTELLIGENCE_GLOBAL_AUDIT")
	os.makedirs(root, exist_ok=True)
	score, gaps = get_global_si_score(), get_gap_status()
